...
class Twemoji
{
	...
	{
		return preg_replace_callback( self::TWEMOJI_REGEX, function( $Matches )
		{
			if( isset( self::$Emojis[ $Matches[ 1 ] ] ) )
			{
				return self::Image( $Matches[ 1 ] );
			}
	 ...
	 * @return string
	 */
	private static function Image( $Name )
	{
		return sprintf(
			'<img src="//cdnjs.cloudflare.com/ajax/libs/twemoji/1.4.1/16x16/%s.png" alt=":%s:" title=":%s:" class="emoji">',
			self::$Emojis[ $Name ],
			$Name,
			$Name
		);
